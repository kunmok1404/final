...
<c:when test="${param.reply_status=='답변대기'}">
	...
	<li><a href="ono_list_ceo?page=${startBlock-1}&reply_status=${param.reply_status}&apply_status=${param.apply_status}&keyword_type=${param.keyword_type}&keyword=${param.keyword}&start_date=${param.start_date}&end_date=${param.end_date}">&lt;&lt;</a></li>
	</c:if>
	
	<%-- 이전 페이지 링크(pno - 1) --%>
	<c:if test="${not (page eq 1)&& not empty page}">
	<li><a href="ono_list_ceo?page=${page-1}&reply_status=${param.reply_status}&apply_status=${param.apply_status}&keyword_type=${param.keyword_type}&keyword=${param.keyword}&start_date=${param.start_date}&end_date=${param.end_date}">&lt;</a></li>
	</c:if>
	...
	<c:if test="${(not (page eq pageCount)) && pageCount>=5}">
		<li><a href="ono_list_ceo?page=${endBlock+1}&reply_status=${param.reply_status}&apply_status=${param.apply_status}&keyword_type=${param.keyword_type}&keyword=${param.keyword}&start_date=${param.start_date}&end_date=${param.end_date}">&gt;&gt;</a></li>
	</c:if>
...
<c:otherwise>
	...
	<%-- 이전 구간 링크 --%>
	<c:if test="${(not (page eq 1))&& not empty page && page>=6}">
	<li><a href="ono_list_ceo?page=${startBlock-1}&apply_status=${param.apply_status}&keyword_type=${param.keyword_type}&keyword=${param.keyword}&start_date=${param.start_date}&end_date=${param.end_date}">&lt;&lt;</a></li>
	</c:if>
	
	<%-- 이전 페이지 링크(pno - 1) --%>
	<c:if test="${not (page eq 1)&& not empty page}">
	<li><a href="ono_list_ceo?page=${page-1}&apply_status=${param.apply_status}&keyword_type=${param.keyword_type}&keyword=${param.keyword}&start_date=${param.start_date}&end_date=${param.end_date}">&lt;</a></li>
	</c:if>
	...
	<%-- 다음 구간 --%>
	<c:if test="${(not (page eq pageCount)) && pageCount>=5}">
		<li><a href="ono_list_ceo?page=${endBlock+1}&apply_status=${param.apply_status}&keyword_type=${param.keyword_type}&keyword=${param.keyword}&start_date=${param.start_date}&end_date=${param.end_date}">&gt;&gt;</a></li>
	</c:if>
