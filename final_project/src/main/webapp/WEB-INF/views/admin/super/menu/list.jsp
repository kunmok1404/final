	  	...
	  	<table class="table table-hamburg table-hover">
	  		<tbody>
	  			...
	  			<tr class="text-center">
	  				<td>${menuVO.no}</td>
	  				<td class="over-text"><a href="${pageContext.request.contextPath}/super_admin/menu/detail?menu_code=${menuVO.no}&shop_code=${menuVO.shop_code}" class="text-primary">${menuVO.name}</a></td>
