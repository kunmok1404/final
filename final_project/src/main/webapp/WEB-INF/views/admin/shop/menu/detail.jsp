...
<div class="wrapper mt-3">
	...
	<form
		action="${pageContext.request.contextPath}/shop_admin/menu/update"
		...
		<table class="table table-hamburg mt-3 menu-regist-table">
			<tbody>
				<tr>
					...
					<td class="text-left"><span class="text-left pl-2"> <select
							name="food_category" class="form-control" required>
								<option>선택</option>
				...
				<tr>
					...
					<td class="text-left"><span class="text-left pl-2"> <select
							name="menu_category" class="form-control" required>
								<option>선택</option>
				...
				<tr>
					...
					<td class="text-left"><input type="text" name="menu_name"
						value="${menuDetailVO.menu_name}" class="form-control"
						placeholder="메뉴명을 입력하세요." required> <input type="hidden"
						name="menu_code" value="${menu_code}"></td>
				</tr>
				<tr>
					<td class="table-secondary text-center">판매&nbsp가격</td>
					<td class="text-left"><input type="number" name="menu_price"
						value="${menuDetailVO.menu_price}" class="form-control" min="1"
						placeholder="가격을 입력하세요." required></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="text-left"><span class="text-left pl-2"> <select
							name="sale_status" class="form-control" required>
								<option>선택</option>
		...
		<table class="table table-hamburg mt-3 menu-regist-table">
			<tbody>
				<tr>
					...
					<td class="text-left"><input type="file" name="menu_list_img"
						class="form-control"> <img class="menu-img"
						src="${pageContext.request.contextPath}/review/review_img?files_code=${menuDetailVO.basic_img}">
					</td>
				...
				<tr>
					...
					<td class="text-left"><input type="file"
						name="menu_detail_img" class="form-control"> <img
						class="menu-img"
						src="${pageContext.request.contextPath}/review/review_img?files_code=${menuDetailVO.detail_img}">
					</td>
					<td class="category-img" width=100px;></td>
				</tr>
			</tbody>
		...
		<table class="table table-hamburg mt-3 menu-regist-table">
			<tbody>
				<tr>
					...
					<td class="text-left">
						<table class="table table-borderless radio-table">
							<tbody>
								<tr>
									<td colspan="2"><input type="text" name="radio_title"
										value="${sub_title.radio_title}" class="form-control"
										placeholder="Ex)소스선택(필수)"></td>
								</tr>
								<tr class="table-primary text-center">
									<td width="50%">필수메뉴명</td>
									<td width="50%">가격</td>
								</tr>
								<c:forEach var="list" items="${radio_list}" varStatus="status"
									step="1">
									<tr>
										<td><input type="text" value="${list.name}"
											name="radioMenuList[${status.index}].radio_name"
											class="form-control radio_name"></td>
										<td><input type="number" value="${list.price}"
											name="radioMenuList[${status.index}].radio_price"
											class="form-control radio_price" min="1"></td>
										<td><button
												class="btn_delete btn-block btn-secondary del">-삭제</button></td>
									</tr>
								</c:forEach>
								<!-- 필수메뉴 템플릿 -->
								<tr class="radio_template">
									<td><input type="text" class="form-control radio_name"></td>
									<td><input type="number" class="form-control radio_price"
										min="1"></td>
				...
				<tr>
					...
					<td class="text-left">
						<table class="table table-borderless check-table">
							<tbody>
								<tr>
									<td colspan="2"><input type="text" name="check_title"
										value="${sub_title.check_title}" class="form-control"
										placeholder="Ex)추가메뉴(선택)"></td>
								</tr>
								<tr class="table-primary text-center">
								...
								<c:forEach var="list" items="${check_list}" varStatus="status"
									...
									<tr>
										<td><input type="text" value="${list.name}"
											name="checkMenuList[${status.index}].check_name"
											class="form-control radio_name"></td>
										<td><input type="number" value="${list.price}"
											name="checkMenuList[${status.index}].check_price"
											class="form-control radio_price" min="1"></td>
										<td><button
												class="btn_delete btn-block btn-secondary del">-삭제</button></td>
									</tr>
								...
								<tr class="check_template">
									...
									<td><input type="number" class="form-control check_price"
										min="1"></td>
									<td><button class="btn_delete btn-block btn-secondary del">-삭제</button></td>
								</tr>
							</tbody>
				...
				<tr class="text-center">
					<td colspan="4"><input type="submit" width="100px"
						class="btn btn-primary edit-btn" value="수정"> <a
						href="${pageContext.request.contextPath}/shop_admin/menu/list"
						class="btn btn-secondary">목록</a></td>
				</tr>
			</tbody>
		</table>
	</form>
