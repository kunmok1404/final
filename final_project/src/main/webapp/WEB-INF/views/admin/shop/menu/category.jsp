        ...
        <div class="wrapper mt-3 food-category-title">
		   <div id="terms-wrapper">
             <div class="terms-line"></div>
	   	   ...
	   	   <span class="font-weight-bold" style="font-size:1.3rem;">메뉴카테고리 관리</span>
	   	   	<form action="${pageContext.request.contextPath}/shop_admin/menu/category" method="post">
                ...
                <tbody class="input">
                    ...
                    <tr>
                        ...
                        <td>
                        	...
                        	<input type="hidden" name="category[${status.index}].shop_code" value="${cat_list.shop_code}" required>
                        </td>
