		...
		$("input[name=images]").change(function(e){
            ...
            if(this.files && this.files[0]){
                ...
                reader.onload = function(data){//data : 파일 정보
                    $(".choice-img").attr("src", data.target.result);
                };
                //실제로 읽기
          ...
          <table class="table table-hamburg">
            <tbody>
              ...
              <tr>
                ...
                <td class="review-content">
                  <textarea id="mytextarea" name="content" rows="15" class="form-control" placeholder="내용을 입력하세요." required></textarea>
                </td>
              </tr>
              <tr>
              ...
              <tr>
   				<td><img src="${pageContext.request.contextPath}/resources/image/white.png" class="choice-img"></td>
   			  </tr>
            </tbody>
          </table>
