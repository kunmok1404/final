       ...
       <!--주문상세정보 시작-->
        <div class="order-detail-info">
         ...
         <table class="table table-borderless">
             <tbody>
                 <tr>
                     <td class="Detail-title shop-title-name">매장</td>
                     <td class="Detail-content" style="font-size:1.5rem;">
                        <img class="shop-list-img" src="${pageContext.request.contextPath}/review/review_img?files_code=${shopDto.shop_img}">
                         <span class="font-weight-bold align-middle shop-name-title">${shopDto.shop_name}</span>
                     </td>
                 </tr>
                 <tr>
