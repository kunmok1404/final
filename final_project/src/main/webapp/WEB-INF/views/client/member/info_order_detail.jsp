   ...
   <div class="wrapper">
     <div class="row">
       <div class="col-md-12 myInfo-title">
         ...
         <span class="font-weight-bold">주문상세정보</span>
       </div>
     </div>
     <div class="row mt-3">
       <div class="col-md-12">
        ...
        <div class="order-detail-info">
         ...
         <table class="table table-borderless">
             <tbody>
                ...
                <tr>
                 ...
                 <tr>
                     <td class="Detail-title review-title">주문상태</td>
                     <td class="Detail-content">
                         <span  class="text-primary font-weight-bold" style="font-size:1.4rem">${orderDto.order_status}</span>
                     </td>
                 </tr>
                 <tr>
                     <td class="Detail-title review-title">주문일시</td>
                     <td class="Detail-content">
         ...
         <div class="order-detail-info mt-5">
           ...
           <table class="table table-borderless">
               <tbody>
                   <tr>
                     <td class="Detail-title review-title">메뉴</td>
                     <td class="Detail-content">
                         <table class="table">
                             <tbody>
                 ...
                 <tr>
                     <td class="Detail-title review-title">주문합계</td>
                     <td class="Detail-content">
                         <span style="font-size: 1.2rem">${orderDto.total_price}원</span>
                     </td>
                 </tr>
                 <tr>
                     <td class="Detail-title review-title">배달요금</td>
                     <td class="Detail-content">
                         <span>${shopDto.delivery_price}원</span>
                     </td>
                 </tr>
                 <tr>
                     <td class="Detail-title review-title">추가할인</td>
                     <td class="Detail-content">
                         <span class="text-danger">-${orderDto.discount_price}원</span>
                     </td>
                 </tr>
                 <tr>
                     <td class="Detail-title review-title">총 결제금액</td>
                     <td class="Detail-content">
                         <span style="font-size: 1.3rem; color:darkblue;" >${final_price}원</span>
                     </td>
                 </tr>
                 <tr>
                     <td class="Detail-title review-title">결제방식</td>
                     <td class="Detail-content">
         ...
         <div class="order-detail-info mt-5">
           ...
           <table class="table table-borderless">
               <tbody>
                   <tr>
                     <td class="Detail-title review-title">연락처</td>
                     <td class="Detail-content">
                         <span>${memberDto.phone}</span>
                     </td>
                 </tr>
                 <tr>
                     <td class="Detail-title review-title">주소</td>
                     <td class="Detail-content">
                         <span>${memberDto.basic_addr}${memberDto.detail_addr}</span>
                     </td>
                 </tr>
                 <tr>
                     <td class="Detail-title review-title">요청사항</td>
                     <td class="Detail-content">
