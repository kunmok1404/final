...
<div class="empty"></div>
    ...
    <table class="qna-qna">
    	...
    	<!-- 내용  -->
    		...
    		<td class=notice-th3 colspan="3" style="height:200px"><span>${odto.content}</span></td>
    		</tr>
    	<!-- 답변  -->    		
    		<tr>
    		<td class=notice-th style="height:200px"><span>답&nbsp;&nbsp;&nbsp;변</span></td>
    		<td class=notice-th3 colspan="3" style="height:200px"><span>${odto.reply_content}</span></td>
    		</tr>
    	</tbody>
